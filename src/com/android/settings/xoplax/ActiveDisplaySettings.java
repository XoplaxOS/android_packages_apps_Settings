...
import com.android.settings.xoplax.lsn.AppMultiSelectListPreference;
import com.android.settings.xoplax.util.SeekBarPreferenceCHOS;
...
public class ActiveDisplaySettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mEnabledPref.setChecked((Settings.XOPLAX.getInt(mResolver,
                Settings.XOPLAX.ENABLE_ACTIVE_DISPLAY, 0) == 1));
        ...
        if (!DeviceUtils.deviceSupportsProximitySensor(mContext)) {
            ...
            mBypassPref.setChecked((Settings.XOPLAX.getInt(mResolver,
                Settings.XOPLAX.ACTIVE_DISPLAY_BYPASS, 1) != 0));

            int mode = Settings.XOPLAX.getInt(mResolver,
                    Settings.XOPLAX.ACTIVE_DISPLAY_POCKET_MODE, 0);
            ...
            long threshold = Settings.XOPLAX.getLong(mResolver,
                Settings.XOPLAX.ACTIVE_DISPLAY_THRESHOLD, 5000L);
            ...
            mTurnOffModePref.setChecked((Settings.XOPLAX.getInt(mResolver,
                Settings.XOPLAX.ACTIVE_DISPLAY_TURNOFF_MODE, 0) == 1));
        }
        ...
        if (!DeviceUtils.deviceSupportsLightSensor(mContext)) {
            ...
            mSunlightModePref.setChecked((Settings.XOPLAX.getInt(mResolver,
                Settings.XOPLAX.ACTIVE_DISPLAY_SUNLIGHT_MODE, 0) == 1));
        }

        mRedisplayPref = (ListPreference) prefSet.findPreference(KEY_REDISPLAY);
        long timeout = Settings.XOPLAX.getLong(mResolver,
                Settings.XOPLAX.ACTIVE_DISPLAY_REDISPLAY, 0);
        ...
        mAnnoyingNotification.setValue(Settings.XOPLAX.getInt(mResolver,
                Settings.XOPLAX.ACTIVE_DISPLAY_ANNOYING, 0));
        ...
        mShakeThreshold.setValue(Settings.XOPLAX.getInt(mResolver,
                Settings.XOPLAX.ACTIVE_DISPLAY_SHAKE_THRESHOLD, 10));
        ...
        mShakeLongThreshold.setValue(Settings.XOPLAX.getInt(mResolver,
                Settings.XOPLAX.ACTIVE_DISPLAY_SHAKE_LONGTHRESHOLD, 2));
        ...
        mShakeTimeout.setValue(Settings.XOPLAX.getInt(mResolver,
                Settings.XOPLAX.ACTIVE_DISPLAY_SHAKE_TIMEOUT, 10));
        ...
        mShowAmPmPref.setChecked((Settings.XOPLAX.getInt(mResolver,
                Settings.XOPLAX.ACTIVE_DISPLAY_SHOW_AMPM, 0) == 1));
        ...
        int brightness = Settings.XOPLAX.getInt(mResolver,
                Settings.XOPLAX.ACTIVE_DISPLAY_BRIGHTNESS, mMaximumBacklight);
        ...
        timeout = Settings.XOPLAX.getLong(mResolver,
                Settings.XOPLAX.ACTIVE_DISPLAY_TIMEOUT, 8000L);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mRedisplayPref) {
            ...
            Settings.XOPLAX.putInt(mResolver,
                Settings.XOPLAX.ACTIVE_DISPLAY_REDISPLAY, val);
            mRedisplayPref.setSummary(mRedisplayPref.getEntries()[index]);
            return true;
        } else if (preference == mEnabledPref) {
            Settings.XOPLAX.putInt(mResolver,
                    Settings.XOPLAX.ENABLE_ACTIVE_DISPLAY,
            ...
            Settings.XOPLAX.putInt(mResolver,
                Settings.XOPLAX.ACTIVE_DISPLAY_POCKET_MODE, val);
            ...
            Settings.XOPLAX.putInt(mResolver, Settings.XOPLAX.ACTIVE_DISPLAY_BRIGHTNESS, realBrightness);
            return true;
        } else if (preference == mDisplayTimeout) {
            int val = Integer.parseInt((String) newValue);
            int index = mDisplayTimeout.findIndexOfValue((String) newValue);
            Settings.XOPLAX.putInt(mResolver,
                Settings.XOPLAX.ACTIVE_DISPLAY_TIMEOUT, val);
            ...
            Settings.XOPLAX.putInt(mResolver,
                Settings.XOPLAX.ACTIVE_DISPLAY_THRESHOLD, val);
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (preference == mBypassPref) {
            ...
            Settings.XOPLAX.putInt(mResolver,
                    Settings.XOPLAX.ACTIVE_DISPLAY_BYPASS,
                    value ? 1 : 0);
            Settings.XOPLAX.putInt(mResolver,
                    Settings.XOPLAX.ACTIVE_DISPLAY_BYPASS,
                    value ? 1 : 0);
            ...
            Settings.XOPLAX.putInt(mResolver,
                    Settings.XOPLAX.ACTIVE_DISPLAY_SUNLIGHT_MODE,
                    value ? 1 : 0);
            Settings.XOPLAX.putInt(mResolver,
                    Settings.XOPLAX.ACTIVE_DISPLAY_SUNLIGHT_MODE,
                    value ? 1 : 0);
            ...
            Settings.XOPLAX.putInt(mResolver,
                    Settings.XOPLAX.ACTIVE_DISPLAY_SHOW_AMPM,
                    value ? 1 : 0);
        } else if (preference == mTurnOffModePref) {
            value = mTurnOffModePref.isChecked();
            Settings.XOPLAX.putInt(mResolver,
                    Settings.XOPLAX.ACTIVE_DISPLAY_TURNOFF_MODE,
                    value ? 1 : 0);
        } else {
    ...
    private Set<String> getExcludedApps() {
        String excluded = Settings.XOPLAX.getString(mResolver,
    ...
    private void storeExcludedApps(Set<String> values) {
        ...
        Settings.XOPLAX.putString(mResolver,
                Settings.XOPLAX.ACTIVE_DISPLAY_EXCLUDED_APPS, builder.toString());
    }

    private Set<String> getPrivacyApps() {
        String privacies = Settings.XOPLAX.getString(mResolver,
    ...
    private void storePrivacyApps(Set<String> values) {
        ...
        Settings.XOPLAX.putString(mResolver,
                Settings.XOPLAX.ACTIVE_DISPLAY_PRIVACY_APPS, builder.toString());
    }
