...
import com.android.settings.xoplax.weather.WeatherPrefs;
import com.android.settings.xoplax.weather.WeatherRefreshService;
import com.android.settings.xoplax.weather.WeatherService;
...
public class Weather extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mStatusBarLocation.setValue(Settings.XOPLAX.getInt(getContentResolver(),
                Settings.XOPLAX.STATUSBAR_WEATHER_STYLE, 1) + "");
        ...
        mEnableWeather.setChecked(Settings.XOPLAX.getInt(getContentResolver(),
                Settings.XOPLAX.USE_WEATHER, 0) == 1);
        mEnableWeather.setOnPreferenceChangeListener(this);

        mShowLoc = (CheckBoxPreference) findPreference(WEATHER_SHOW_LOACATION);
        mShowLoc.setChecked(Settings.XOPLAX.getInt(getContentResolver(),
                Settings.XOPLAX.WEATHER_SHOW_LOCATION, 0) == 1);
        ...
        if (Settings.XOPLAX.getInt(getContentResolver(),
                Settings.XOPLAX.STATUSBAR_WEATHER_STYLE, 1) == 0) {
        ...
        } else if (Settings.XOPLAX.getInt(getContentResolver(),
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mUseCustomLoc) {
            ...
            Settings.XOPLAX.putInt(getActivity().getContentResolver(),
                    Settings.XOPLAX.WEATHER_SHOW_LOCATION,
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mEnableWeather) {
            ...
            return Settings.XOPLAX.putInt(getActivity().getContentResolver(),
                    Settings.XOPLAX.STATUSBAR_WEATHER_STYLE,
                    Integer.parseInt(newVal));

        } else if (preference == mWeatherShortClick) {

            mPreference = preference;
            mString = Settings.XOPLAX.WEATHER_PANEL_SHORTCLICK;
            if (newValue.equals(ACTION_APP)) {
                ...
                result = Settings.XOPLAX.putString(getContentResolver(), Settings.XOPLAX.WEATHER_PANEL_SHORTCLICK, (String) newValue);
                mWeatherShortClick.setSummary(getProperSummary(mWeatherShortClick));
            }
            ...
            mPreference = preference;
            mString = Settings.XOPLAX.WEATHER_PANEL_LONGCLICK;
            if (newValue.equals(ACTION_APP)) {
                final String label = getResources().getString(R.string.lockscreen_target_empty);
                final ShortcutIconResource iconResource =
                        ShortcutIconResource.fromContext(getActivity(), android.R.drawable.ic_delete);
                ...
                result = Settings.XOPLAX.putString(getContentResolver(), Settings.XOPLAX.WEATHER_PANEL_LONGCLICK, (String) newValue);
                mWeatherLongClick.setSummary(getProperSummary(mWeatherLongClick));
            }
    ...
    public void shortcutPicked(String uri, String friendlyName, boolean isApplication) {
        ...
        Settings.XOPLAX.putString(getContentResolver(), mString, (String) uri);
    }
    ...
    private String getProperSummary(Preference preference) {
        ...
        String uri = Settings.XOPLAX.getString(getActivity().getContentResolver(),mString);
        String empty = "";
