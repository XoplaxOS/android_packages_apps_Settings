...
package com.android.settings.xoplax.weather;
...
public class WeatherService extends IntentService {
    ...
    public static final String INTENT_WEATHER_REQUEST = "com.xoplax.INTENT_WEATHER_REQUEST";
    public static final String INTENT_WEATHER_UPDATE = "com.xoplax.INTENT_WEATHER_UPDATE";
    public static final String INTENT_EXTRA_ISMANUAL = "com.xoplax.INTENT_EXTRA_ISMANUAL";
    public static final String INTENT_EXTRA_TYPE = "com.xoplax.INTENT_EXTRA_TYPE";
    public static final String INTENT_EXTRA_NEWLOCATION = "com.xoplax.INTENT_EXTRA_NEWLOCATION";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (Settings.XOPLAX.getInt(getContentResolver(), Settings.XOPLAX.USE_WEATHER, 0) == 0) {
            stopSelf();
            return;
        }
