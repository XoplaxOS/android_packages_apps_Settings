package com.android.settings.xoplax.util.aokp;
 ...
 * supported: "xoplax", and "system". Defaults to "xoplax" if none is specified. Note that there is no namespace on this attribute.
 * </ul>
 * <p/>
...
public class BaseSetting extends LinearLayout {
    ...
    /**
     * @return the table which the setting will be saved to. Currently only 'xoplax' and 'system' are supported
     */
