...
import com.android.internal.util.xoplax.AwesomeConstants;
...
import com.android.settings.xoplax.util.aokp.dslv.DragSortController;
import com.android.settings.xoplax.util.aokp.dslv.DragSortListView;
import com.android.settings.xoplax.widgets.ShortcutPickerHelper;
import com.android.settings.xoplax.widgets.ShortcutPickerHelper.OnPickListener;
...
public class ArrangeNavbarFragment extends SettingsPreferenceFragment implements OnPickListener {
    ...
    private void saveUserConfig() {
        ...
        Settings.XOPLAX.putString(getActivity().getContentResolver(), Settings.XOPLAX.NAVIGATION_BAR_BUTTONS, s.toString());
    }

    private void readUserConfig() {
        mNavButtons.clear();
        String buttons = Settings.XOPLAX.getString(getActivity().getContentResolver(), Settings.XOPLAX.NAVIGATION_BAR_BUTTONS);
