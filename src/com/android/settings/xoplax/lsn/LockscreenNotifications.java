...
public class LockscreenNotifications extends SettingsPreferenceFragment implements Preference.OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mLockscreenNotifications.setChecked(Settings.XOPLAX.getInt(cr,
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS, 0) == 1);

        mPocketMode = (CheckBoxPreference) prefs.findPreference(KEY_POCKET_MODE);
        mPocketMode.setChecked(Settings.XOPLAX.getInt(cr,
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_POCKET_MODE, 0) == 1);
        ...
        mShowAlways.setChecked(Settings.XOPLAX.getInt(cr,
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_SHOW_ALWAYS, 0) == 1);
        ...
        mWakeOnNotification.setChecked(Settings.XOPLAX.getInt(cr,
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_WAKE_ON_NOTIFICATION, 0) == 1);
        ...
        mHideLowPriority.setChecked(Settings.XOPLAX.getInt(cr,
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_HIDE_LOW_PRIORITY, 0) == 1);
        ...
        mDynamicWidth.setChecked(Settings.XOPLAX.getInt(cr,
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_DYNAMIC_WIDTH, 0) == 1);
        ...
        mHideNonClearable.setChecked(Settings.XOPLAX.getInt(cr,
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_HIDE_NON_CLEARABLE, 0) == 1);
        ...
        mDismissAll.setChecked(Settings.XOPLAX.getInt(cr,
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_DISMISS_ALL, 0) == 1);
        ...
        mPrivacyMode.setChecked(Settings.XOPLAX.getInt(cr,
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_PRIVACY_MODE, 0) == 1);
        ...
        mExpandedView.setChecked(Settings.XOPLAX.getInt(cr,
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_EXPANDED_VIEW, 0) == 1);
        ...
        mForceExpandedView.setChecked(Settings.XOPLAX.getInt(cr,
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_FORCE_EXPANDED_VIEW, 0) == 1);
        ...
        mOffsetTop.setProgress((int)(Settings.XOPLAX.getFloat(cr,
                Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_OFFSET_TOP, 0.3f) * 100));
        ...
        mNotificationsHeight.setValue(Settings.XOPLAX.getInt(cr,
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_HEIGHT, 4));
        ...
        int color = Settings.XOPLAX.getInt(cr,
                Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_COLOR, 0x55555555);
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (preference == mLockscreenNotifications) {
            Settings.XOPLAX.putInt(cr, Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS,
            ...
            Settings.XOPLAX.putInt(cr, Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_POCKET_MODE,
                    mPocketMode.isChecked() ? 1 : 0);
            mShowAlways.setEnabled(mPocketMode.isChecked());
        } else if (preference == mShowAlways) {
            Settings.XOPLAX.putInt(cr, Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_SHOW_ALWAYS,
                    mShowAlways.isChecked() ? 1 : 0);
        } else if (preference == mWakeOnNotification) {
            Settings.XOPLAX.putInt(cr, Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_WAKE_ON_NOTIFICATION,
                    mWakeOnNotification.isChecked() ? 1 : 0);
        } else if (preference == mHideLowPriority) {
            Settings.XOPLAX.putInt(cr, Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_HIDE_LOW_PRIORITY,
                    mHideLowPriority.isChecked() ? 1 : 0);
        } else if (preference == mHideNonClearable) {
            Settings.XOPLAX.putInt(cr, Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_HIDE_NON_CLEARABLE,
                    mHideNonClearable.isChecked() ? 1 : 0);
            mDismissAll.setEnabled(!mHideNonClearable.isChecked());
        } else if (preference == mDismissAll) {
            Settings.XOPLAX.putInt(cr, Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_DISMISS_ALL,
                    mDismissAll.isChecked() ? 1 : 0);
        } else if (preference == mExpandedView) {
            Settings.XOPLAX.putInt(cr, Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_EXPANDED_VIEW,
                    mExpandedView.isChecked() ? 1 : 0);
            mForceExpandedView.setEnabled(mExpandedView.isChecked());
        } else if (preference == mForceExpandedView) {
            Settings.XOPLAX.putInt(cr, Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_FORCE_EXPANDED_VIEW,
                    mForceExpandedView.isChecked() ? 1 : 0);
        } else if (preference == mPrivacyMode) {
            Settings.XOPLAX.putInt(cr, Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_PRIVACY_MODE,
                    mPrivacyMode.isChecked() ? 1 : 0);
            mForceExpandedView.setEnabled(mLockscreenNotifications.isChecked() && mExpandedView.isChecked()
                        && !mPrivacyMode.isChecked());
            mExpandedView.setEnabled(mLockscreenNotifications.isChecked() && !mPrivacyMode.isChecked());
        } else if (preference == mDynamicWidth) {
            Settings.XOPLAX.putInt(cr, Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_DYNAMIC_WIDTH,
    ...
    public boolean onPreferenceChange(Preference pref, Object value) {
        if (pref == mNotificationsHeight) {
            Settings.XOPLAX.putInt(getContentResolver(),
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_HEIGHT, (Integer)value);
        } else if (pref == mOffsetTop) {
            Settings.XOPLAX.putFloat(getContentResolver(), Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_OFFSET_TOP,
                    (Integer)value / 100f);
            ...
            Settings.XOPLAX.putInt(getActivity().getContentResolver(),
                    Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_COLOR, intHex);
            return true;
    ...
    private Set<String> getExcludedApps() {
        String excluded = Settings.XOPLAX.getString(getContentResolver(),
    ...
    private void storeExcludedApps(Set<String> values) {
        ...
        Settings.XOPLAX.putString(getContentResolver(),
                Settings.XOPLAX.LOCKSCREEN_NOTIFICATIONS_EXCLUDED_APPS, builder.toString());
    }
}
