...
public class PieTriggerSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSensitivity.setValue(Settings.XOPLAX.getInt(getContentResolver(),
                Settings.XOPLAX.PIE_TRIGGER_SENSITIVITY, 4));
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mDisableImeTriggers) {
            Settings.XOPLAX.putInt(getContentResolver(),
                    Settings.XOPLAX.PIE_IME_CONTROL,
                    (Boolean) newValue ? 1 : 0);
        } else if (preference == mSensitivity) {
            int sensitivity = ((Integer)newValue).intValue();
            Settings.XOPLAX.putInt(getContentResolver(),
                    Settings.XOPLAX.PIE_TRIGGER_SENSITIVITY, sensitivity);
        } else {
    ...
    public void onResume() {
        ...
        getContentResolver().registerContentObserver(
                Settings.XOPLAX.getUriFor(Settings.XOPLAX.PIE_GRAVITY), true,
                mPieTriggerObserver);
    ...
    private void updatePieTriggers() {
        int triggerSlots = Settings.XOPLAX.getInt(getContentResolver(),
                Settings.XOPLAX.PIE_GRAVITY, DEFAULT_POSITION);
        ...
        mDisableImeTriggers.setChecked(Settings.XOPLAX.getInt(getContentResolver(),
                Settings.XOPLAX.PIE_IME_CONTROL, 1) == 1);
    }
