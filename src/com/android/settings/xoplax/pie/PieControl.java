    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mPieControl) {
            ...
            Settings.XOPLAX.putInt(getContentResolver(),
                    Settings.XOPLAX.PIE_CONTROLS, (Boolean) newValue ? 1 : 0);
        } else if (preference == mPieMenuDisplay) {
            Settings.XOPLAX.putInt(getContentResolver(),
                    Settings.XOPLAX.PIE_MENU, Integer.parseInt((String) newValue));
        }
        return true;
    }

    private void updateSettings() {
        mPieMenuDisplay.setValue(Settings.XOPLAX.getInt(getContentResolver(),
                Settings.XOPLAX.PIE_MENU,
                2) + "");
        mPieControl.setChecked(Settings.XOPLAX.getInt(getContentResolver(),
                Settings.XOPLAX.PIE_CONTROLS, 0) == 1);
    }
