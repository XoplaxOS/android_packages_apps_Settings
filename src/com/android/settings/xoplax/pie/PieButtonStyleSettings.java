...
public class PieButtonStyleSettings extends SettingsPreferenceFragment implements
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mPieButtonColor) {
            ...
            Settings.XOPLAX.putInt(getActivity().getContentResolver(),
                    Settings.XOPLAX.PIE_BUTTON_COLOR, intHex);
            return true;
            ...
            int intHex = ColorPickerPreference.convertToColorInt(hex);
            Settings.XOPLAX.putInt(getActivity().getContentResolver(),
                    Settings.XOPLAX.PIE_BUTTON_PRESSED_COLOR, intHex);
            return true;
            ...
            int intHex = ColorPickerPreference.convertToColorInt(hex);
            Settings.XOPLAX.putInt(getActivity().getContentResolver(),
                    Settings.XOPLAX.PIE_BUTTON_LONG_PRESSED_COLOR, intHex);
            return true;
            ...
            int intHex = ColorPickerPreference.convertToColorInt(hex);
            Settings.XOPLAX.putInt(getActivity().getContentResolver(),
                    Settings.XOPLAX.PIE_BUTTON_OUTLINE_COLOR, intHex);
            return true;
            ...
            int intHex = ColorPickerPreference.convertToColorInt(hex);
            Settings.XOPLAX.putInt(getActivity().getContentResolver(),
                    Settings.XOPLAX.PIE_ICON_COLOR, intHex);
            return true;
       } else if (preference == mPieButtonAlpha) {
            float val = Float.parseFloat((String) newValue);
            Log.e("R", "value: " + val / 100);
            Settings.XOPLAX.putFloat(getActivity().getContentResolver(),
                    Settings.XOPLAX.PIE_BUTTON_ALPHA,
                    val / 100);
            return true;
            ...
            Log.e("R", "value: " + val / 100);
            Settings.XOPLAX.putFloat(getActivity().getContentResolver(),
                    Settings.XOPLAX.PIE_BUTTON_PRESSED_ALPHA,
                    val / 100);
            return true;
            ...
            Settings.XOPLAX.putInt(getContentResolver(),
                    Settings.XOPLAX.PIE_ICON_COLOR_MODE,
                    value);
    ...
    private void updateStyleValues() {
        ...
        try{
            defaultAlpha = Settings.XOPLAX.getFloat(getActivity()
                     .getContentResolver(), Settings.XOPLAX.PIE_BUTTON_ALPHA);
        } catch (Exception e) {
            defaultAlpha = 0.3f;
            Settings.XOPLAX.putFloat(getActivity().getContentResolver(),
                Settings.XOPLAX.PIE_BUTTON_ALPHA, defaultAlpha);
        }
        mPieButtonAlpha.setInitValue((int) (defaultAlpha * 100));

        try{
            defaultAlpha = Settings.XOPLAX.getFloat(getActivity()
                     .getContentResolver(), Settings.XOPLAX.PIE_BUTTON_PRESSED_ALPHA);
        } catch (Exception e) {
            defaultAlpha = 0.0f;
            Settings.XOPLAX.putFloat(getActivity().getContentResolver(),
                Settings.XOPLAX.PIE_BUTTON_PRESSED_ALPHA, defaultAlpha);
        }
        mPieButtonPressedAlpha.setInitValue((int) (defaultAlpha * 100));

        int pieIconColorMode = Settings.XOPLAX.getInt(getActivity().getContentResolver(),
                Settings.XOPLAX.PIE_ICON_COLOR_MODE, 0);
