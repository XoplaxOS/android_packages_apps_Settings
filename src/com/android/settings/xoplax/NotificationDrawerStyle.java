...
public class NotificationDrawerStyle extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mForceExpanded.setChecked((Settings.XOPLAX.getInt(resolver,
        ...
        float transparency;
        try{
            transparency = Settings.XOPLAX.getFloat(getContentResolver(),
                    Settings.XOPLAX.NOTIFICATION_BACKGROUND_ALPHA);
        } catch (Exception e) {
            transparency = 0;
            Settings.XOPLAX.putFloat(getContentResolver(),
        ...
        try{
            ...
            transparency = 0;
            Settings.XOPLAX.putFloat(getContentResolver(),
                    Settings.XOPLAX.NOTIFICATION_ALPHA, 0.0f);
        }
    ...
    private void updateCustomBackgroundSummary() {
        int resId;
        String value = Settings.XOPLAX.getString(getContentResolver(),
        ...
        value = Settings.XOPLAX.getString(getContentResolver(),
    ...
    public void deleteWallpaper(boolean orientation) {
        String path = Settings.XOPLAX.getString(getContentResolver(),
                Settings.XOPLAX.NOTIFICATION_BACKGROUND);
        ...
        path = Settings.XOPLAX.getString(getContentResolver(),
                Settings.XOPLAX.NOTIFICATION_BACKGROUND_LANDSCAPE);
        if (path != null) {
            File wallpaperToDelete = new File(Uri.parse(path).getPath());
            ...
            if (orientation) {
                Settings.XOPLAX.putString(getContentResolver(),
                    Settings.XOPLAX.NOTIFICATION_BACKGROUND_LANDSCAPE, null);
            }
        }
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == Activity.RESULT_OK) {
            if (requestCode == REQUEST_PICK_WALLPAPER
                ...
                if (requestCode == REQUEST_PICK_WALLPAPER) {
                    Settings.XOPLAX.putString(getContentResolver(),
                        Settings.XOPLAX.NOTIFICATION_BACKGROUND, path);
                } else {
                    Settings.XOPLAX.putString(getContentResolver(),
                        Settings.XOPLAX.NOTIFICATION_BACKGROUND_LANDSCAPE, path);
                }
            }
        } else {
            if (mImageTmp.exists()) {
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if  (preference == mForceExpanded) {
            ...
            Settings.XOPLAX.putInt(getActivity().getContentResolver(),
                    Settings.XOPLAX.FORCE_EXPANDED_NOTIFICATIONS, checked ? 1:0);
        }
        return true;
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mWallpaperAlpha) {
            ...
            Settings.XOPLAX.putFloat(getContentResolver(),
                    Settings.XOPLAX.NOTIFICATION_BACKGROUND_ALPHA, valNav / 100);
            return true;
        } else if (preference == mNotificationAlpha) {
            float valNav = Float.parseFloat((String) newValue);
            Settings.XOPLAX.putFloat(getContentResolver(),
                    Settings.XOPLAX.NOTIFICATION_ALPHA, valNav / 100);
            return true;
            ...
            switch (indexOf) {
                ...
                case 2:
                    ...
                    Settings.XOPLAX.putString(getContentResolver(),
                            Settings.XOPLAX.NOTIFICATION_BACKGROUND, null);
                    updateCustomBackgroundSummary();
                    break;
            }
            return true;
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            switch (id) {
                case DLG_PICK_COLOR:
                    ...
                    String currentColor = Settings.XOPLAX.getString(
