...
import com.android.settings.xoplax.util.XoplaXCheckBoxPreference;
...
public class TintedStatusbar extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTintedStatusbarTransparency.setValue(Settings.XOPLAX.getInt(resolver,
                Settings.XOPLAX.STATUS_BAR_TINTED_STATBAR_TRANSPARENT, 100));
        ...
        if (!hasNavBarByDefault && !enableNavigationBar) {
            ...
            mTintedNavbarTransparency.setValue(Settings.XOPLAX.getInt(resolver,
                    Settings.XOPLAX.STATUS_BAR_TINTED_NAVBAR_TRANSPARENT, 100));
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mTintedStatusbar) {
            ...
            Settings.XOPLAX.putInt(resolver,
                Settings.XOPLAX.STATUS_BAR_TINTED_COLOR, val);
            ...
            Settings.XOPLAX.putInt(resolver,
                Settings.XOPLAX.STATUS_BAR_TINTED_OPTION, val);
            ...
            Settings.XOPLAX.putInt(resolver,
                    Settings.XOPLAX.STATUS_BAR_TINTED_STATBAR_TRANSPARENT, val);
            return true;
        } else if (preference == mTintedNavbarTransparency) {
            int val = ((Integer)newValue).intValue();
            Settings.XOPLAX.putInt(resolver,
                    Settings.XOPLAX.STATUS_BAR_TINTED_NAVBAR_TRANSPARENT, val);
            return true;
        } else {
            return false;
        }
    ...
    private int getTintedStatusbarColor(ContentResolver resolver) {
        int tintedStatusbar = Settings.XOPLAX.getInt(resolver,
                    Settings.XOPLAX.STATUS_BAR_TINTED_COLOR, 0);
        return tintedStatusbar;
    }

    private int getTintedStatusbarOption(ContentResolver resolver) {
        int tintedStatusbarOption = Settings.XOPLAX.getInt(resolver,
                    Settings.XOPLAX.STATUS_BAR_TINTED_OPTION, 0);
